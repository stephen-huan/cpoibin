...
class PoiBin(object):
    ...
    def __init__(self, probabilities):
        ...
        """
        # force double to satisfy Cython strict typing
        self.success_probabilities = np.array(probabilities, dtype=np.float64)
...
# ------------------------------------------------------------------------------
    ...
    def pval(self, number_successes):
        ...
        i = 0
        try:
            isinstance(number_successes, collections.abc.Iterable)
...
# ------------------------------------------------------------------------------
    ...
    def get_cdf(self, event_probabilities):
        ...
        """
        return np.cumsum(event_probabilities)
    ...
    def get_pmf_xi(self):
        ...
        """
        pmf = pdf(self.success_probabilities)
        assert np.isclose(np.sum(pmf), 1), "pmf is not valid"
        return pmf
